...
public class LaunchBrowser {
    public static void main(String[] args) {
        ...
        String chromeAbsoluteDriverLocation = currentProjectLocation.concat(chromeDriverLocation);
        System.setProperty("webdriver.chrome.driver", chromeAbsoluteDriverLocation);
